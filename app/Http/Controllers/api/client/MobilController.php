...
class MobilController extends Controller
{
    ...
    function tampilMobil()
    {
        ...
        try {
            ...
            $dataMobil = $mobilModel->clientGetCar()->get();
    ...
    function cariMobil(Request $request)
    {
        ...
        try {
            ...
            // $dataBahanBakar = BahanBakarModel::get();
            $dataMobil = $mobilModel->searchCar($keyword)->get();
            $dataFinance = FInanceModel::first();
    ...
    function filterMobil(Request $request)
    {
        ...
        try {
            ...
            //$dataBahanBakar = BahanBakarModel::get();
            $dataMobil = $mobilModel->filterCar($merk, $body, $transmisi, $priceFrom, $priceEnd)->get(); //tambah $bahanBakarId
            $dataFinance = FInanceModel::first();
