...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('template/admin/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
...
<body>
    <script src="{{ asset('template/admin/assets/static/js/initTheme.js') }}"></script>
    <div id="app">
        <div id="sidebar">
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('template/admin/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset=""></a>
            </div>
                                ...
                                <div class="col-7">
                                    <div class="d-flex align-items-center">
                                        <svg class="bi text-primary" width="32" height="32" fill="blue"
                                            style="width:10px">
                                            <use
                                                xlink:href="{{ asset('template/admin/assets/static/images/bootstrap-icons.svg#circle-fill') }}" />
                                        </svg>
                ...
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="{{ asset('template/admin/assets/compiled/jpg/1.jpg') }}" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset('template/admin/assets/compiled/jpg/4.jpg') }}">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset('template/admin/assets/compiled/jpg/5.jpg') }}">
                        </div>
                        <div class="name ms-4">
