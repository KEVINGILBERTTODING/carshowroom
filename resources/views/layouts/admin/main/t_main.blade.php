...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('data/app/img/' . $dataApp['logo']) }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('template/admin/assets/compiled/css/rating.css') }}">
