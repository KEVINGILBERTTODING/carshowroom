                    ...
                    <li class="sidebar-item  has-sub">
                        ...
                        <ul class="submenu ">
                            ...
                            <li class="submenu-item active">
                                <a href="form-element-input.html" class="submenu-link">Warna</a>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#modal_insert">Tambah
                    Warna</button>
            </div>
            <div class="card-body">
