        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-title active">Utilitas</li>
        ...
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="section-lead">
                    Form untuk mengubah konten pada website
                </p>
            </div>
        ...
        <div class="section-body">
            <div class="row mt-sm-4">
                <div class="col-12 col-md-6 col-lg-6">
                    <form action="{{ route('updateDataShowroom') }}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <h4>Data Showroom</h4>
                                <div class="row mt-3">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input name="app_name" required type="text" class="form-control"
                                            autocomplete="off" value="{{ $dataApp['app_name'] }}">

                                    </div>

                                    <div class="form-group col-md-6 col-12">
                                        <label>No Handphone</label>
                                        <input name="no_hp" required type="text" class="form-control"
                                            autocomplete="off" value="{{ $dataApp['no_hp'] }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input name="email" required type="text" class="form-control"
                                            autocomplete="off" value="{{ $dataApp['email'] }}">

                                    </div>

                                    <div class="form-group col-md-6 col-12">
                                        <label>Jadwal Showroom</label>
                                        <input name="jadwal" required type="text" class="form-control"
                                            autocomplete="off" value="{{ $dataApp['jadwal'] }}">
                                ...
                                <div class="form-group ">
                                    <label>Alamat</label>
                                    <textarea name="alamat" rows="3" required type="text" class="form-control" autocomplete="off">{{ $dataApp['alamat'] }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label>Url Facebook</label>
                                    <textarea name="url_facebook" rows="3" required type="text" class="form-control" autocomplete="off">{{ $dataApp['url_facebook'] }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label>Url Instagram</label>
                                    <textarea name="url_instagram" rows="3" required type="text" class="form-control" autocomplete="off">{{ $dataApp['url_instagram'] }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label>Url Youtube</label>
                                    <textarea name="url_youtube" rows="3" required type="text" class="form-control" autocomplete="off">{{ $dataApp['url_youtube'] }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label>Visi</label>
                                    <textarea name="visi" rows="4" required type="text" class="form-control" autocomplete="off">{{ $dataApp['visi'] }}</textarea>
                                </div>

                                <div class="form-group ">
                                    <label>Misi</label>
                                    <textarea name="misi" rows="4" required type="text" class="form-control" autocomplete="off">{{ $dataApp['misi'] }}</textarea>
                                </div>
                    ...
                    <form action="{{ route('updateContent') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group col-md-6 col-12">
                                        <label class="mb-3">Logo Showroom</label>
                                        <br>
                                        <img class="w-50 img-fluid mb-3"
                                            src="{{ asset('data/app/img/' . $dataApp['logo']) }}" alt="">
                                        <input type="file" accept=".png,.jpeg,.jpg" name="logo"
                                            class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <br>
                                        <img class="w-50 img-fluid mb-3"
                                            src="{{ asset('template/client/img/main/' . $dataApp['img_about_us2']) }}"
                                            alt="">
                                        <input type="file" accept=".png,.jpeg,.jpg" name="img_about_us2"
                                            class="form-control">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <br>
                                        <img class="w-50 img-fluid mb-3"
                                            src="{{ asset('template/client/img/about/' . $dataApp['img_about_us']) }}"
                                            alt="">
                                        <input type="file" accept=".png,.jpeg,.jpg" name="img_about_us"
                                            class="form-control">
