...
@section('title')
    @if (session('role') == 'admin')
        <title>Admin - Filter Transaksi</title>
    @elseif (session('role') == 'employee')
        <title>Karyawan - Filter Transaksi</title>
    @else
        <title>Pemilik - Filter Transaksi</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-sm">Periode: {{ $dateFrom . ' S/d ' . $dateEnd }}</p>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Filter Transaksi</li>
                    </ol>
                </nav>
            </div>
        </div>
