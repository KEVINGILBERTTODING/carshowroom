...
@section('title')
    @if (session('role') == 'admin')
        <title>Admin - Transaksi Finance</title>
    @elseif (session('role') == 'employee')
        <title>Karyawan - Transaksi Finance</title>
    @else
        <title>Pemilik - Transaksi Finance</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Seluruh Transaksi Proses Finance</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Transaksi Finance</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" hidden>
                                ...
                                <input value="3" name="status" class="form-control">
                            </div>
