...
@section('title')
    @if (session('role') == 'admin')
        <title>Admin - Transaksi Tidak Valid</title>
    @elseif (session('role') == 'employee')
        <title>Karyawan - Transaksi Tidak Valid</title>
    @else
        <title>Pemilik - Transaksi Tidak Valid</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Seluruh Transaksi Tidak Valid</h3>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" hidden>
                                ...
                                <input value="0" name="status" class="form-control">
                            </div>
