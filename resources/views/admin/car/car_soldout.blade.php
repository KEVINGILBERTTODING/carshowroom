...
@section('title')
    @if (session('role') == 'admin')
        <title>Admin - Mobil Telah Terjual</title>
    @else
        <title>Karyawan - Mobil Telah Terjual</title>
    @endif
@endsection
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Daftar Mobil Telah Terjual</h3>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Mobil Terjual</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Table Daftar Mobil Telah Terjual
                </h5>
                ...
                @if ($dataMobil != null)
                    <div class="d-flex justify-content-end mt-2">
                        <a class="btn btn-success" href="{{ route('downloadReportCars', 0) }}"> <i
