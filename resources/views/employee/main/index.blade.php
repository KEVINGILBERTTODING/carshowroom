                        ...
                        <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="user-menu d-flex">
                                <div class="user-name text-end me-3">
                                    <h6 class="mb-0 text-gray-600">{{ $dataKaryawan['name'] }}</h6>
                                    <p class="mb-0 text-sm text-gray-600">Employee</p>
                                </div>
                                <div class="user-img d-flex align-items-center">
                                    <div class="avatar avatar-md">
                                        <img src="{{ asset('data/profile_photo/' . $dataKaryawan['photo_profile']) }}">
                                    </div>
                                </div>
                            </div>
                        </a>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var waktu = new Date();
            var username = "{{ $dataKaryawan['name'] }}";
